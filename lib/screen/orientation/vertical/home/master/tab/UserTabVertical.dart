...
class UserTabVertical extends StatefulWidget {
  @override
  _UserTabVerticalState createState() => _UserTabVerticalState();
}

class _UserTabVerticalState extends State<UserTabVertical> {
  User? selectedUser;
  String searchQuery = '';
  User? loggedUser;
